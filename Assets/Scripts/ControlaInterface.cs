...
public class ControlaInterface : MonoBehaviour {
    ...
    public Slider SliderStaminaJogador;
	...
	void Start () {
        ...
        SliderStaminaJogador.maxValue = scriptControlaJogador.statusJogador.Stamina;
        AtualizarSliderVidaJogador();
        AtualizarStaminaJogador();
        Time.timeScale = 1;
    ...
    public void AtualizarStaminaJogador(){
        SliderStaminaJogador.value = scriptControlaJogador.statusJogador.Stamina;
    }
